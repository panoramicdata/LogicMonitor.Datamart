...
namespace LogicMonitor.Datamart.Migrations
{
    ...
    [Migration("20191024151014_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogicMonitor.Datamart.Models.DeviceDataSourceInstanceAggregatedDataStoreItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("DeviceDataSourceInstanceId", "DataPointId", "Hour");

                    b.ToTable("DeviceDataSourceInstanceAggregatedData");
                });
            ...
            modelBuilder.Entity("LogicMonitor.Datamart.Models.DeviceDataSourceInstanceAggregatedDataStoreItem", b =>
                {
                    b.HasOne("LogicMonitor.Datamart.Models.DataSourceDataPointStoreItem", "DataPoint")
                        .WithMany("DeviceDataSourceInstanceAggregatedDataStoreItems")
                    ...
                    b.HasOne("LogicMonitor.Datamart.Models.DeviceDataSourceInstanceStoreItem", "DeviceDataSourceInstance")
                        .WithMany("AggregatedDataMeasures")
